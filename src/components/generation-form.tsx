        ...
        <Card className='flex w-full flex-col overflow-visible rounded-lg border border-white/10 bg-black lg:h-full lg:overflow-hidden'>
            <CardHeader className='flex items-start justify-between border-b border-white/10 pb-4'>
                <div>
                    ...
                    <CardDescription className='mt-1 text-white/60'>根据文本提示词创建新图片。</CardDescription>
                </div>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col lg:h-full lg:flex-1 lg:overflow-hidden'>
                <CardContent className='space-y-5 p-4 lg:flex-1 lg:overflow-y-auto'>
                                ...
                                <TooltipTrigger asChild>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <Label
                                            ...
                                            className={`text-sm ${n[0] > 1 ? 'cursor-not-allowed text-white/40' : '无效'}`}>
                                            Enable Streaming
                                        </Label>
                                    </div>
                                </TooltipTrigger>
                    ...
                    <div className='space-y-1.5'>
                        ...
                        <Textarea
                            id='prompt'
                            placeholder='例如：一只写实风格的宇航员猫漂浮在太空中'
                            value={prompt}
                        ...
                        {isGptImage2 && size === 'custom' && (
                            <div className='space-y-2 rounded-md border border-white/10 bg-white/5 p-3'>
                                ...
                                <p className='text-xs text-white/50'>
                                    ...
                                    {((customWidth * customHeight) / 8_294_400 * 100).toFixed(1)}% 上限）·{' '}
                    ...
                    <div className='space-y-3'>
                        <Label className='block text-white'>审核强度</Label>
                        <RadioGroup
                            value={moderation}
