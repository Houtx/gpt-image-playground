                    ...
                    {totalCost > 0 && (
                        <Dialog open={isTotalCostDialogOpen} onOpenChange={setIsTotalCostDialogOpen}>
                            ...
                            <DialogContent className='border-neutral-700 bg-neutral-900 text-white sm:max-w-[450px]'>
                                <DialogHeader>
                                    <DialogTitle className='text-white'>总费用汇总</DialogTitle>
                                ...
                                <div className='space-y-1 pt-1 text-xs text-neutral-400'>
                                    ...
                                    <ul className='list-disc pl-4'>
                                        ...
                                        <li>图片输入：$8 / 1M tokens</li>
                                        <li>图片输出：$30 / 1M tokens</li>
                                    </ul>
                                    <p className='mt-2 font-medium'>gpt-image-1.5:</p>
                                    <ul className='list-disc pl-4'>
                                        <li>文本输入：$5 / 1M tokens</li>
                                        <li>图片输入：$8 / 1M tokens</li>
                                        <li>图片输出：$32 / 1M tokens</li>
                                    </ul>
                                    <p className='mt-2 font-medium'>gpt-image-1:</p>
                                    <ul className='list-disc pl-4'>
                                        <li>文本输入：$5 / 1M tokens</li>
                                        <li>图片输入：$10 / 1M tokens</li>
                                        <li>图片输出：$40 / 1M tokens</li>
                                    </ul>
                                    <p className='mt-2 font-medium'>gpt-image-1-mini:</p>
                                    <ul className='list-disc pl-4'>
                                        <li>文本输入：$2 / 1M tokens</li>
                                        <li>图片输入：$2.50 / 1M tokens</li>
                                        <li>图片输出：$8 / 1M tokens</li>
                                    </ul>
                                </div>
                                <div className='space-y-2 py-4 text-sm text-neutral-300'>
                                    <div className='flex justify-between'>
                                        <span>图片总数：</span> <span>{totalImages.toLocaleString()}</span>
                                    </div>
                                    <div className='flex justify-between'>
                                        <span>平均单图费用：</span> <span>${averageCost.toFixed(4)}</span>
                                    </div>
                                                ...
                                                <DialogContent className='border-neutral-700 bg-neutral-900 text-white sm:max-w-md'>
                                                    <DialogHeader>
                                                        ...
                                                        <DialogDescription className='pt-2 text-neutral-300'>
                                                            确定要删除这条历史记录吗？将删除 {item.images.length} 张图片，此操作无法撤销。
                                                        </DialogDescription>
                                                    </DialogHeader>
